...
This repo contains a "milkyway.exe" file under "Release", less than 3kB (2.43kB or 2495 Bytes to be exact) in size. It will run on any Windows 10 or 11 machine with a proper graphics adapter and OpenGL drivers.
